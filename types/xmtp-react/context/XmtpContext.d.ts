...
export declare type XmtpContextType = DisconnectedXmtp | IdleXmtp | WaitingXmtp | DeniedXmtp | LoadingXmtp | ReadyXmtp | ErrorXmtp;
export declare const XmtpContext: import("react").Context<XmtpContextType>;
